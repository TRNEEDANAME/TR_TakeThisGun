...
class X2Effect_TR_TemporaryItem extends X2Effect_Persistent;
...
simulated protected function OnEffectAdded(const out EffectAppliedData ApplyEffectParameters, XComGameState_BaseObject kNewTargetState, XComGameState NewGameState, XComGameState_Effect NewEffectState)
{
	...
	local XComGameState_TR_Effect_TemporaryItem	EffectState;
	...
	EffectState = XComGameState_TR_Effect_TemporaryItem(NewEffectState);
	if (EffectState == none)
		return;
...
simulated function OnEffectRemoved(const out EffectAppliedData ApplyEffectParameters, XComGameState NewGameState, bool bCleansed, XComGameState_Effect RemovedEffectState)
{
	...
	EffectState = XComGameState_TR_Effect_TemporaryItem(RemovedEffectState);
...
static function EventListenerReturn OnTacticalGameEnd(Object EventData, Object EventSource, XComGameState GameState, Name EventID, Object CallbackData)
{
	...
	EffectState = XComGameState_TR_Effect_TemporaryItem(CallbackData);
...
static function ClearTemporaryItems(XComGameState_TR_Effect_TemporaryItem EffectState, XComGameState NewGameState)
{
	local XComGameStateHistory		History;
...
defaultProperties
{
	...
	GameStateEffectClass=class'XComGameState_TR_Effect_TemporaryItem';
}
